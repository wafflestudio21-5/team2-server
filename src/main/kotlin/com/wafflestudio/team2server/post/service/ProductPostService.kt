...
interface ProductPostService {
	...
	fun searchPostByKeyword(cur: Long, keyword: String, refAreaId: List<Int>, distance: Int, count: Int): ProductPostController.ListResponse
	...
	fun getPostListRandom(cur: Long, seed: Int, areaId: Int, distance: Int, count: Int): ProductPostController.ListResponse
}
