...
class AuthService(
	...
	fun login(email: String, password: String): AuthController.TokenResponse {
		...
		return AuthController.TokenResponse(uid, refAreaIds, isAdmin, token)
	}

	fun socialLogin(provider: AuthProvider, idToken: String): AuthController.TokenResponse {
